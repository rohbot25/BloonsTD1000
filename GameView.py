...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        if (self.selected_map == "images/RiverMap.png"):
            position_list = [
            [190,450],
            [160,410],
            [110,440],
    ...
    def on_draw(self):
        ...
        if not self.show_upgrade:
            ...
            tower_images = [buy_fisherman,buy_god,buy_boat,buy_fly_fisherman,buy_neanderthal,buy_wizard,buy_fisherman,buy_archer]
